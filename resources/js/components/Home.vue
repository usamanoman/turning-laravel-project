	 ...
	 <div class="homepage">
        <nav class="p-4 d-flex align-items-center justify-content-around">
            ...
            <ul class="p-0 m-0 no-list">
                <li><a href="#">Home</a></li>
                <li><router-link :to="{ name: 'category' }">Catalog</router-link></li>
            </ul>
            <div>
                <span @click="showCart()" class="fa-layers fa-fw mr-2" style="font-size:25px;">
                ...
                <div class="col-md-12">
                    <div class="upperhead">
                        <div class="upperhead__content">
                            ...
                            <router-link class="btn btn-big btn-light" :to="{ name: 'category' }">View All</router-link>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <router-link :to="{ name: 'category', query: { 'search' : true, 'category' : 1 } }">
                        ...
                        <div class="col-md-12">
                            <div class="lowerheader__widget lowerheader__widget--3 shadow">
                                ...
                                <div class="lowerheader__widget__content">
                                    ...
                                    <router-link class="btn btn-big btn-pink" :to="{ name: 'category', query: { 'search' : true, 'department' : 3 } }">View All</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
