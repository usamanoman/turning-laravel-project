...
class ShippingController extends Controller
{
    ...
    {
        return response()->json(ShippingRegion::all(), 200);
    }
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getShippingType(ShippingRegion $shipping_region)
    {
        return response()->json($shipping_region->shipping);
    }
}
